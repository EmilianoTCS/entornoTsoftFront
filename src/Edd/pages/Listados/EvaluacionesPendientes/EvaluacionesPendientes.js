...
export default function ListadoEvaluacionesPendientes() {
...
//     var url = "pages/listados/listadoEvaluacionesPorEmpleado.php";
//     var operationUrl = "listadoEvaluacionesPorEmpleado";
//     var data = {
//       num_boton: num_boton,
    ...
    <>
      ...
      <Container id="fondoTabla">
        <div id="containerTablas">
          <h1 id="TitlesPages"> Listado de evaluaciones asiganadas</h1>
          <h6 style={{ color: "gray" }}>
            EDD {"->"} Formulario evaluaciones
          </h6>
          <br></br>
          ...
          <Table id="mainTable" hover responsive>
            ...
            {/* <tbody>
              {EDDEvalPregunta.map((idEDDEvaluacion) => (
                <tr key={idEDDEvaluacion.idEDDEvaluacion}>
                  <td>{idEDDEvaluacion.idEDDEvaluacion}</td>
                  <td>{idEDDEvaluacion.nomEvaluacion}</td>
