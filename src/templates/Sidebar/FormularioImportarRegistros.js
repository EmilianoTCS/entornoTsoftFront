...
export default function FormularioImportarRegistros({
  isActive,
  cambiarEstado,
}) {
  ...
  function SubirArchivo(e) {
    ...
    var data = {
      idRegistro: 1,
      nomTabla: "plantilla_carga_registro",
      descripcion: "plantilla_carga_registro",
      isActive: "1",
      usuarioCreacion: userData.usuario,
    };
    SendFilesService(
      "/pages/gestorArchivos/importacionRegistrosBase.php",
    ...
    <>
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title>Importación de datos al sistema</Modal.Title>
        </Modal.Header>
        <Modal.Body>
              ...
              <p style={styleDescPlantilla}>
                ...
                >
                  <DownloadFilesService
                    idRegistro={"1"}
                    nomTabla={"plantilla_carga_registros"}
                    baseURL={
