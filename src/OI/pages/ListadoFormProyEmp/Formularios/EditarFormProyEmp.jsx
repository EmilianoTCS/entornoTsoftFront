...
export default function EditarFormProyEmp({
  isActive,
  cambiarEstado,
  datosFila,
}) {
  ...
  function SendData(e) {
    ...
    const url = "pages/editar/oi_editarFormProyEmp.php";
    const operationUrl = "oi_editarFormProyEmp";
    var data = {
      idFormEddProyEmp: datos.idFormEddProyEmp,
      idFormulario: datos.idFormulario,
      idEDDProyEmp: datos.idEDDProyEmp,
      isActive: datos.isActive || 1,
      usuarioCreacion: userData.usuario,
    };
    console.log(data);
  ...
  useEffect(
    function () {
      ...
      if (datosFila) {
        setDatos({
          idFormEddProyEmp: datosFila.idFormEddProyEmp,
          idFormulario: datosFila.idFormulario,
          idEDDProyEmp: datosFila.idEDDProyEmp,
    ...
    <>
      <Modal show={show} onHide={handleClose} backdrop="static" keyboard={true}>
        <Modal.Header closeButton>
          <Modal.Title>Editar formulario - proyecto - colaborador</Modal.Title>
        </Modal.Header>
        <Modal.Body>
            ...
            <div className="form-group">
              ...
              >
                ...
                {auxList.listadoFormularios.map((valor) => (
                  <option
                    selected={datos.idFormulario === valor.idFormulario}
                    value={valor.idFormulario}
                  >
                    {valor.nomFormulario}
                  </option>
                ))}
            ...
            <div className="form-group">
              ...
              >
                ...
                {auxList.listadoEddProyEmp.map((valor) => (
                  <option
                    selected={datos.idEDDProyEmp === valor.idEDDProyEmp}
