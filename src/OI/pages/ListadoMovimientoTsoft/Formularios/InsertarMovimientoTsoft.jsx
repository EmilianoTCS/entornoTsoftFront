...
import "../ListadoMovimientoTsoft.css";
...
export default function InsertarMovimientoTsoft({ isActive, cambiarEstado }) {
  const handleClose = () =>
    ...
    <>
      <Modal show={show} onHide={handleClose} backdrop="static" keyboard={true}>
        <Modal.Header closeButton>
          <Modal.Title>Crear movimiento colaborador - TSOFT</Modal.Title>
        </Modal.Header>
        <Modal.Body>
